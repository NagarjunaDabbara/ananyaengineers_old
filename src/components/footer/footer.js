...
<div className="row">
   <div className="mycompanyname">
     <p className="text-white">©Copyright 2019. All rights reserved | Designed by
	<a href="http://www.trinetrawebtechnologies.com" target="_blank"> Trinetra Web Technologies </a>
     </p>
      </div>
